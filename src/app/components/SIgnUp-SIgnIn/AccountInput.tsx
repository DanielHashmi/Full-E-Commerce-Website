...
const AccountInput = ({ currentPage }: { currentPage: string }) => {
    return (
        <div className="flex flex-col items-start w-full md:w-1/3 gap-4 p-6 md:p-0">
            ...
            <button className="w-full py-3 rounded-md text-white bg-[#db4444]">Create Account</button>
            ...
            <div className="flex items-center mt-6 w-full justify-between ">
                {currentPage === 'login' && <button className="px-12 sm:px-6 lg:px-12 py-3 rounded-sm text-white bg-[#db4444]">Log in</button>
                }
